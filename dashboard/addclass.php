<div>
    ...
    <div class="modal-content animated slideInDown">
      ...
      <form style=" margin-top: 2%;"  method="POST" action="addclassdb.php" enctype="multipart/form-data"> 
 <div class="form-group">
          <label for="class">Grade  :</label>
          <input type="text" class="form-control" placeholder="Eg Grade 1 , Grade 2 , Grade 3 .. " name="class" style="margin-left: 2%" required>
        </div>
