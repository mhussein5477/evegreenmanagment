<div>
	 <div id="id05" class="modal" style="color: black">


    <div class="modal-content animated slideInUp">
      <span onclick="document.getElementById('id05').style.display='none'" class="close" title="Close Modal" style="margin-top: 3%;">&times;</span>
     
    


      <form style=" margin-top: 2%;"  method="POST" action="addfeesdb.php" enctype="multipart/form-data"> 
 <div class="form-group">
          <label for="class">Use this for new students <font style="color: grey; font-style: italic;">(This will add fees to this student only)</font> </label>
