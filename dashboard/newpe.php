<div>
	 <div id="id08" class="modal" style="color: black">


    <div class="modal-content animated slideInDown">
      <span onclick="document.getElementById('id08').style.display='none'" class="close" title="Close Modal" style="margin-top: 3%;">&times;</span>
     
    
<h6>PE Uniform Payment Details</h6>

      <form style=" margin-top: 2%;"  method="POST" action="newpedb.php" enctype="multipart/form-data"> 
        ...
        <br>
              <input type="submit" style="margin-top: 3%;" class="btn btn-warning py-2 px-4" >  
