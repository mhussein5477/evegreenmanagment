...
<?php 
	...
	$pe_id = $_GET['info'];
	$sql = $db -> query("SELECT * FROM pe WHERE id = '$pe_id' ");
...
<section id="printableArea">
	<div style="margin-top: 10%; padding-left: 5%; padding-right: 5%; padding-top: 3%; padding-bottom: 3%; border: 1px solid grey; margin-left: 0% ; margin-right: 0%">
		...
		<u><i><h5 style="text-align: center;">PE uniform receipt</h5></i></u>
		<h6 style="float: right; margin-right: 5%">Receipt No : <?php echo  $pe_id ; ?></h6><br>
